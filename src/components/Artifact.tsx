      ...
      {url ? (
        <Link href={url}>
          ...
          >
            ...
            <CardContent
              className={cn('prose flex dark:prose-p:text-foreground', {
                'justify-end dark:prose-p:text-background': index % 2 === 1,
              })}
            >
              <p
            ...
            <CardFooter
              className={cn(
                'flex flex-col flex-wrap gap-4 sm:w-1/2 sm:flex-row',
                {
